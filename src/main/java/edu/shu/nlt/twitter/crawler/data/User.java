...
public class User {
	 ...
	 * @return User
	 */
	public static User getInstance(winterwell.jtwitter.User user) {
		return new User(user.getId().intValue(), user.getScreenName(), user.getName(), user.getLocation(), user.getDescription());
	}
